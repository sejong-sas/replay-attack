...
SEQ_INDEX_CSV = "/home/saslab01/Desktop/replay_pad/frame_index/replayattack_10frame_index.csv"
...
def evaluate_sequence_scores(model, split):
    ...
    out_csv = os.path.join(PRED_DIR, f"image_10frame_avg_{split}_sequence_predictions.csv")
...
def main():
    ...
    devel_video_csv = os.path.join(PRED_DIR, "image_10frame_avg_devel_video_predictions.csv")
    test_video_csv = os.path.join(PRED_DIR, "image_10frame_avg_test_video_predictions.csv")
    ...
    out_json = os.path.join(RESULT_DIR, "mobilenetv3_small_10frame_avg_eval_results.json")
